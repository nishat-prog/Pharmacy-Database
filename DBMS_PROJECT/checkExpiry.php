...
if(mysqli_connect_errno()){
	...
	$query="Select medicine_id,medicine_name,company_id,supplier_id,expiry_date from medicine where expiry_date between '$today' and '$tenDaysLater';";
	$res=mysqli_query($con,$query);
	if(mysqli_error($con)){
		print(mysqli_error($con));
	}
	else{
		echo "<br><br><strong>Medicines that will be expiring within 10 days are</strong><br><br><br>";
